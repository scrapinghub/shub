...
from shub.hubstorage import HubStorageQueryLogs as Query

@click.command(help='Get log records of a given job on Scrapy Cloud')
@click.pass_context
@click.argument('job_id')
@click.option('-t', '--output-format', help='the format of the data to be printed', required=False, type=click.Choice(Query.get_allowed_formats().keys()), default='text')
